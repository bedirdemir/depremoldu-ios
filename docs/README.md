...
| Belge | İçerik |
|---|---|
| [ARCHITECTURE](ARCHITECTURE.md) | Katmanlar, veri akışı, bağımlılık yönü |
| [PRODUCT_SCOPE](PRODUCT_SCOPE.md) | Sürüm 1.0.0 kapsamı ve web parite tablosu |
| [BRANCHING_RELEASES](BRANCHING_RELEASES.md) | Dal modeli, promotion kapıları, sürüm/build politikası |
| [TESTING_STRATEGY](TESTING_STRATEGY.md) | Test katmanları, determinizm, komutlar |
| [CURRENT_STATE](CURRENT_STATE.md) | Güncel durum, bekleyen kabul, riskler |
